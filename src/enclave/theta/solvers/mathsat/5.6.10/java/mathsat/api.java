...
public class api {
  ...
  public static final int MSAT_TAG_FP_TO_SBV = 59;
  public static final int MSAT_TAG_FP_TO_UBV = 60;
  public static final int MSAT_TAG_FP_AS_IEEEBV = 61;
  public static final int MSAT_TAG_FP_ISNAN = 62;
  public static final int MSAT_TAG_FP_ISINF = 63;
  public static final int MSAT_TAG_FP_ISZERO = 64;
  public static final int MSAT_TAG_FP_ISSUBNORMAL = 65;
  public static final int MSAT_TAG_FP_ISNORMAL = 66;
  public static final int MSAT_TAG_FP_ISNEG = 67;
  public static final int MSAT_TAG_FP_ISPOS = 68;
  public static final int MSAT_TAG_FP_FROM_IEEEBV = 69;
  public static final int MSAT_TAG_INT_FROM_UBV = 70;
  public static final int MSAT_TAG_INT_FROM_SBV = 71;
  public static final int MSAT_TAG_INT_TO_BV = 72;
  public static final int MSAT_TAG_PI = 73;
  public static final int MSAT_TAG_EXP = 74;
  public static final int MSAT_TAG_SIN = 75;
  public static final int MSAT_TAG_LOG = 76;
  ...
  public static boolean MSAT_ERROR_CONFIG(long c) {
    return c == 0;
  }

  public static boolean MSAT_ERROR_ENV(long e) {
    return e == 0;
  }
  ...
  public static boolean MSAT_ERROR_TYPE(long t) {
    return t == 0;
  }
  ...
  public static boolean MSAT_ERROR_MODEL(long m) {
    return m == 0;
  }
  ...
  // of arguments
  public static long msat_get_function_type(long e, long[] paramTypes, long returnType) {
    return msat_get_function_type(e, paramTypes, paramTypes.length, returnType);
  }

  public static long[] msat_is_enum_type(long e, long tp) {
    return msat_is_enum_type(e, tp, 0, 0);
  }
  ...
  public static int msat_visit_term(long e, long term, VisitTermCallback func) {
    return msat_visit_term(e, term, func, 0);
  }

  public static int msat_solve_diversify(
      long e, long[] diversifiers, SolveDiversifyModelCallback func) {
    return msat_solve_diversify(e, diversifiers, diversifiers.length, func, 0);
  }
  ...
  public static String msat_named_list_to_smtlib2(long e, String[] names, long[] terms) {
    return msat_named_list_to_smtlib2(e, names.length, names, terms);
  }

  public static Object[] msat_annotated_list_from_smtlib2(long e, String data) {
  ...
  public static String msat_annotated_list_to_smtlib2(long e, long[] terms, String[] annots) {
  ...
  public static long msat_exist_elim(
      long env, long formula, long[] vars_to_elim, int algo, ExistElimOptions opts) {
    int[] options =
        new int[] {
          opts.toplevel_propagation, opts.boolean_simplifications, opts.remove_redundant_constraints
        };
    return msat_exist_elim(env, formula, vars_to_elim, vars_to_elim.length, algo, options);
  }

  public static long msat_exist_elim_model(
      long env, long formula, long[] vars_to_elim, long[] model_vars, long[] model_values) {
    return msat_exist_elim_model(
        env,
        formula,
        vars_to_elim,
        vars_to_elim.length,
  ...
  public static long msat_apply_substitution(long env, long term, long[] to_subst, long[] values) {
    return msat_apply_substitution(env, term, to_subst.length, to_subst, values);
  }
  ...
  public static long msat_simplify(long env, long formula, long[] to_protect) {
    return msat_simplify(env, formula, to_protect, to_protect == null ? 0 : to_protect.length);
  }
  ...
  public static native long msat_get_function_type(
      long env, long[] param_types, int num_params, long return_type);

  public static native long msat_get_enum_type(
      long env, String name, int domain_size, String[] domain);
  ...
  public static native int msat_is_fp_type(
      long env, long tp, int[] out_exp_width, int[] out_mant_width);

  public static native int msat_is_fp_roundingmode_type(long env, long tp);

  public static native long[] msat_is_enum_type(
      long env, long tp, int out_domain_size, int out_domain);

  public static native int msat_type_equals(long t1, long t2);

  public static native String msat_type_repr(long t);

  public static native int msat_type_id(long t);
  ...
  public static native long msat_make_int_modular_congruence(
      long e, String modulus, long t1, long t2);
  ...
  public static native long msat_make_fp_to_sbv(long e, int width, long rounding, long t);

  public static native long msat_make_fp_to_bv(long e, int width, long rounding, long t);

  public static native long msat_make_fp_to_ubv(long e, int width, long rounding, long t);

  public static native long msat_make_fp_from_sbv(
      long e, int exp_w, int mant_w, long rounding, long t);
  ...
  public static native long msat_make_fp_rat_number(
      long e, String num_rep, int exp_w, int mant_w, long rounding);
  ...
  public static native int msat_term_is_enum_value(long e, long t);
  ...
  public static native int msat_term_is_fp_to_sbv(long e, long t);

  public static native int msat_term_is_fp_to_bv(long e, long t);

  public static native int msat_term_is_fp_to_ubv(long e, long t);
  ...
  public static native long msat_apply_substitution(
      long e, long t, int n, long[] to_subst, long[] values);
  ...
  public static native String msat_to_smtlib2_ext(
      long e, long term, String logic_name, int use_defines);

  public static native String msat_to_smtlib2_term(long e, long term);

  public static native Object[] msat_named_list_from_smtlib2(
      long e, String data, int out_n, int out_names, int out_terms);

  public static native String msat_named_list_to_smtlib2(
      long e, int n, String[] names, long[] terms);

  public static native Object[] msat_annotated_list_from_smtlib2(
      long e, String data, int out_n, int out_terms, int out_annots);

  public static native String msat_annotated_list_to_smtlib2(
      long e, int n, long[] terms, String[] annots);
  ...
  public static native int msat_solve_with_assumptions(
      long e, long[] assumptions, int num_assumptions);

  public static native int msat_all_sat(
      long e, long[] important, int num_important, AllSatModelCallback func, int user_data);

  public static native int msat_solve_diversify(
      long e,
      long[] diversifiers,
      int num_diversifiers,
  ...
  public static native long msat_exist_elim(
      long env, long formula, long[] vars_to_elim, int num_vars_to_elim, int algo, int[] options);

  public static native long msat_exist_elim_model(
      long env,
      long formula,
      long[] vars_to_elim,
      int num_vars_to_elim,
      long[] model_vars,
      long[] model_values,
      int model_size);
