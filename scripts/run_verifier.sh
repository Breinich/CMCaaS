...
run_verifier() {
    ...
    occlum run /usr/lib/jvm/java-21-openjdk-amd64/bin/java -Xms1G -Xmx2G -XX:-UseCompressedOops -XX:MaxMetaspaceSize=64m -Dos.name=Linux VerifierRunner "${enclave_id}"
}
