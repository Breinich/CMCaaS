...
public class api {
    ...
    public static native long msat_get_enum_type(long env, String name, int domain_size, String[] domain);
    ...
    public static native long[] msat_is_enum_type(long env, long tp, int out_domain_size, int out_domain);
